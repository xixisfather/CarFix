...
<html>
	...
	<body>
		<s:form id="formId" action="tbBookUpdateAction.action">
			<table>
				<tr>
					<td>
						<s:hidden name="tbBook.id"/>
						<s:hidden name="tbBook.isCome" />
					</td>
				</tr>
					<tr>
					<td>
					...
					<td>
						<s:textfield id="registerDate" name="tbBook.registerDate"
							>
							<s:param name="value"><s:date name="tbBook.registerDate" format="yyyy-MM-dd HH:mm:ss"/></s:param>
						</s:textfield>	
				...
				<tr>
					...
					<td>
						<s:textfield id="planFixTime" name="tbBook.planFixTime"
							>
							<s:param name="value"><s:date name="tbBook.planFixTime" format="yyyy-MM-dd HH:mm:ss"/></s:param>
						</s:textfield>	
...
<script language="javascript">
	...
	//E3表格初始化
	function e3TableInit(){
		
		
		acquireStationTypeByCarModel('init');
		
		//setTimeout('e3TableReFresh()',2000);
		
	}
	
	function e3TableReFresh(){
