...
<html>
	...
	<table id="mainTable"  >
		...
		<s:iterator value="#request.storeHouseCheckDetails" id="detail" status="idx">
			<tr id="TR${detail.tbPartInfo.id}">
				...
				<td><input type="text" style="width:80px" value="${detail.checkQuantity }"  onchange="jsprice('${detail.tbPartInfo.id}');" id="checkquantity${detail.tbPartInfo.id}"  /></td>
				...
				<td align="right" >
					<span id="op${detail.tbPartInfo.id}" style="cursor:pointer;color:blue" onclick="delcheckrow('${detail.tbPartInfo.id}')" >删除</span> 
	...
	&nbsp;&nbsp;<input type="button" id="saveBtn" value="添加商品" onclick="nextTip()" />
	<br>
	</body>  
