...
<html>
	...
	<script type="text/javascript">
		...
		function tbPartInfoTableE3ConfigHandler(pConfig) {
			...
			pConfig.form = "getNotBalanceFixSellCostDetailStatAction";
	...
	<body>
		<s:form action="getNotBalanceFixSellCostDetailStatAction.action">
			<table>
				<tr>	
					<td>修理日期</td>
		...
		<e3t:table id="tbPartInfoTable" uri="getNotBalanceFixSellCostDetailStatAction.action" var="tbPartInfo"
			scope="request" items="results" mode="ajax" 
			toolbarPosition="bottom" skin="E3002" pageSize="10" width="1000"
			height="320" >
			
			<e3t:column width="100" property="fixDate" title="修理日期" >
				<fmt:formatDate value="${tbPartInfo.fixDate}" pattern="yyyy-MM-dd" />
			</e3t:column>
