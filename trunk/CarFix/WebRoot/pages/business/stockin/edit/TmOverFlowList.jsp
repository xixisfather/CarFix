...
<html>
	...
	<script type="text/javascript">
		...
		function tmStockInTableConfigHandler(pConfig) {
			...
			{	
				...
				iconCls : 'addIcon',
				handler : function() {
					//window.location.href = ctx+"/initOverFlowPageAction.action";
					addObject('initOverFlowPageAction.action',800,450);
				}
			}, '', '-', '', {
				text : '刷新',
				iconCls : 'refreshIcon',
		...
		function tmStockInTableE3ConfigHandler(pConfig) {
			...
			pConfig.form = "findOverFlowAction";
	...
	<body>
		...
		<e3t:table id="tmStockInTable" uri="findOverFlowAction.action" var="stockIn"
			scope="request" items="stockInList" mode="ajax" caption="报溢单列表"
			...
			<e3t:column property="arriveDate"  title="报溢日期" >
			...
			<e3t:column property="no" title="操作"
				sortable="false">
				<a href="javascript:editObject('${stockIn.id}','initEditOverFlowPageAction.action',800,450)">
					<font color="blue">
						修改
					</font>
				</a>
				...
				&nbsp;&nbsp;
				<a href="javascript:editObject('${stockIn.id}','printPJBYAction.action',600,300);">
					<font color="blue">
						打印
					</font>
				</a>
