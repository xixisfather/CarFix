...
var pt = '';
	...
	<body>
		<s:form action="tbWorkingInfoQueryAction.action">
			<table>
				<tr>
					<td>工位代码</td>
					<td>
		...
		<e3t:table id="tbWorkingInfoTable" uri="tbWorkingInfoQueryAction.action" var="tbWorkingInfo"
			scope="request" items="tbWorkingInfoList" mode="ajax"
			toolbarPosition="bottom" skin="E3002" pageSize="500" width="1000"
			height="260" caption="工时工位" varStatus="status">
			...
			<e3t:column property="no" title="操作"
				sortable="false">
				<a href="javascript:editObject('${tbWorkingInfo.id}','tbWorkingInfoWtsForwardPageAction!forwardPage.action',600,300);">
					<font color="blue">
						修改
					</font>
				</a>
