...
<html>
	...
	<body>
		<s:form id="importXlsForm" action="tbWorkingInfoImportXlsAction.action" enctype="multipart/form-data">
			<table>
				<tr>
					<td>选择数据文件</td>
					<td>
				...
				<tr>
					<td>选择车型工位</td>
					<td>
						<s:select id="tmCarStationTypeId" name="tmCarStationTypeId" list="#request.tmCarStationTypeMap" listKey="key" listValue="value"></s:select>
					</td>
