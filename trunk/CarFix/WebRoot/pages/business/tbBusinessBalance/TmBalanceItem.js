...
function calcAjax(itemCode)
{
	...
	var tbFixEntrustId = parent.document.getElementById('tbFixEntrustId').value;
	...
	var url = 'tmBalanceItemCalcAjaxAction.action?tbFixEntrustId=' + tbFixEntrustId + '&tmBalanceId='+ tmBalanceId + '&itemCode=' + itemCode + '&itemVal=' + itemVal + '&time=' + time;
