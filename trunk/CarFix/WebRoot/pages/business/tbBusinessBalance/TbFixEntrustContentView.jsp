    	...
    	<s:form action="tbFixEntrustContentViewAction.action" >
    		<table>
    			<tr>
    				...
    				<td>
    					<input type="text" id="workingHourFavourRate" name="workingHourFavourRate" value="<s:property value='#request.tbBusinessBalance.workingHourFavourRate'/>" disabled="true"/>
    				</td>
    				<td>
						合计 				
    				</td>
