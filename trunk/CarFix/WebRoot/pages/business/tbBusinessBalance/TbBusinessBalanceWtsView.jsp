...
<script language="javascript">
	Ext.onReady(function(){
		...
		[
			...
			{
				id:'tbFixEntrustContent' , title:'修理工时',disabled:false,url:'tbFixEntrustContentViewAction.action?tbFixEntrustId='+tbFixEntrustId.value + '&tbBusinessBalanceId='+tbBusinessBalanceId.value
			},
			{
				id:'tbFixEntrustPartContent' , title:'修理材料',disabled:false,url:'viewEntrustSellStockAction.action?entrustId='+tbFixEntrustId.value + '&tbBusinessBalanceId='+tbBusinessBalanceId.value
			},
			{
				id:'tbFixEntrustPartSoleContent' , title:'销售材料',disabled:false,url:'viewEntrustSellDetailAction.action?trustBill='+entrustCode.value + '&tbBusinessBalanceId='+tbBusinessBalanceId.value
			},
			{
				id:'tmBalanceItemTab' , title:'结算项目明细',disabled:false,url:'tmBalanceItemCalcViewAction.action?tbBusinessBalanceId='+tbBusinessBalanceId.value+'&tmBalanceId='+tmBalanceId.value
			}
