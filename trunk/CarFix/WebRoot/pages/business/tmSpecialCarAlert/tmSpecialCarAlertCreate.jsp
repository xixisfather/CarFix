...
<html>
	...
	<body>
		<s:form action="insertTmSpecialCarAlertAction.action">
			...
			<table>
				<tr>
					...
					<td>
						<s:textfield id="licenseCode" readonly="true" onfocus="openWin();" ></s:textfield><font color="red">*</font>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<s:textfield id="beginDate" name="tmSpecialCarAlert.beginDate"></s:textfield>
				...
				<tr>
					...
					<td>
						<s:textfield id="endDate" name="tmSpecialCarAlert.endDate"></s:textfield>
