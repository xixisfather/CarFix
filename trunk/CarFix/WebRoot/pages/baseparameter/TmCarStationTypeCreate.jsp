...
<html>
	<head>
		<title><s:text name="TM_FLAG_CAR_ADD" />
		</title>
	...
	<body>
		<s:form action="tmCarStationTypeInsertAction.action" onsubmit="return formValidate()">
			<table>
				<tr>
					<td>
				...
				<tr>
					...
					<td>	
						<s:textarea id="stationRemark" name="tmCarStationType.stationRemark" />
