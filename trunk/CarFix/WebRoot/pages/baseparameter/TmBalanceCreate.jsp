...
<html>
	...
	<body>
		<s:form action="tmBalanceInsertAction.action" onsubmit="return formValidate()">
			<table>
				...
				<tr>
					<td colspan="2">
						<s:radio name="tmBalance.balanceType" list="#request.balanceTypeMap" listKey="key" listValue="value" value="1"></s:radio>
					</td>
				</tr>
				<tr>
