...
<html>
	...
	<body>
		<s:form action="tmCardTypeInsertAction.action" onsubmit="return formValidate()">
			<table width="90%">
				<tr>
					<td>
						卡种名称
				...
				<tr>
					<td>
						...
						<s:textfield id="gsMFullMoney" name="tmCardType.gsMFullMoney" size="4" value="100"/><font color="red">*</font>
						
						&nbsp;元&nbsp;返&nbsp;还&nbsp;
						
						<s:textfield id="gsMGiveMoney" name="tmCardType.gsMGiveMoney" size="4" value="0"/><font color="red">*</font>
				...
				<tr>
					<td>
						...
						<s:textfield id="pjMFullMoney" name="tmCardType.pjMFullMoney" size="4" value="100"/><font color="red">*</font>
						
						&nbsp;元&nbsp;返&nbsp;还&nbsp;
						
						<s:textfield id="pjMGiveMoney" name="tmCardType.pjMGiveMoney" size="4" value="0"/><font color="red">*</font>
				...
				<tr>
					<td>
						...
						<s:textfield id="gsPFullMoney" name="tmCardType.gsPFullMoney" size="4" value="100"/><font color="red">*</font>
						
						&nbsp;元&nbsp;返&nbsp;还&nbsp;
						
						<s:textfield id="gsPGivePoint" name="tmCardType.gsPGivePoint" size="4" value="0"/><font color="red">*</font>
				...
				<tr>
					<td>
						...
						<s:textfield id="pjPFullMoney" name="tmCardType.pjPFullMoney" size="4" value="100"/><font color="red">*</font>
						
						&nbsp;元&nbsp;返&nbsp;还&nbsp;
						
						<s:textfield id="pjPGivePoint" name="tmCardType.pjPGivePoint" size="4" value="0"/><font color="red">*</font>
				...
				<tr>
					<td>
						...
						<s:textfield id="yhMFullMoney" name="tmCardType.yhMFullMoney" size="4" value="100"/><font color="red">*</font>
						
						&nbsp;元&nbsp;扣&nbsp;除&nbsp;
						
						<s:textfield id="yhMMinusPoint" name="tmCardType.yhMMinusPoint" size="4" value="0"/><font color="red">*</font>
				...
				<tr>
					<td>
						&nbsp;&nbsp;&nbsp;&nbsp;1.一&nbsp;次&nbsp;性&nbsp;充&nbsp;值&nbsp;<s:textfield id="cFullMoney" name="tmCardType.cFullMoney" size="4" value="100"/><font color="red">*</font>&nbsp;元&nbsp;送&nbsp;<s:textfield id="cGiveMoney" name="tmCardType.cGiveMoney" size="4" value="0"/><font color="red">*</font>&nbsp;元&nbsp;<s:textfield id="cGivePoint" name="tmCardType.cGivePoint" size="4" value="0"/><font color="red">*</font>&nbsp;积&nbsp;分
					</td>
				</tr>
				...
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;1.工&nbsp;时&nbsp;优&nbsp;惠&nbsp;率<s:textfield id="gsYhl" name="tmCardType.gsYhl" size="4" value="0.00" onkeyup="clearNoNum22(this,0.01,1.00)"/><font color="red">*</font></td>
				</tr>
