...
<html>
	...
	<body>
		<s:form action="tbWorkingCollectionFindAction.action">
			<table>
				<tr>
					<td>工位集代号</td>
					...
					<td>车型工位</td>
					<td><s:select id="tmCarStationTypeId" name="tbWorkingCollection.tmCarStationType.id" list="#request.tmCarStationTypeMap" listKey="key" listValue="value" onchange="tbWorkingCollectionTableQuery();"></s:select></td>
				</tr>
				<tr>	
					<td>
		...
		<e3t:table id="tbWorkingCollectionTable" uri="tbWorkingCollectionFindAction.action" var="tbWorkingCollection"
			scope="request" items="tbWorkingCollectionList" mode="ajax"
			toolbarPosition="bottom" skin="E3002" pageSize="10" width="700"
			height="360" caption="工位集">
