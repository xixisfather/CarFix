...
<body onload="document.getElementById('currentCardNo').focus();">
<s:form action="tbMembershipCardHKAction.action"  onsubmit="return validateCurrentNo();">
	...
	<table>
		...
		<tr>
			...
			<td>
				<s:textfield id="currentCardNo" name="tbMembershipCard.currentCardNo" onkeydown="EnterTab();"></s:textfield>
			</td>
		</tr>
		<tr>
...
<script language="javascript">
	function validateCurrentNo(){

		var currentCardNo = document.getElementById('currentCardNo');

		if(currentCardNo.value==''){
