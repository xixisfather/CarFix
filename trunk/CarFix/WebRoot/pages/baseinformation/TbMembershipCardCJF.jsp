...
<body>
<s:form action="tbMembershipCardCJFAction.action" onsubmit="return validateData();">
	...
	<table>
		...
		<tr>
			...
			<td>
				<s:hidden id="pass" value=""></s:hidden>
				<s:textfield id="czjf" name="tbMembershipCard.czjf" maxlength="10" value="0" onkeyup="sendCJF('add');"></s:textfield>
			</td>
		</tr>
