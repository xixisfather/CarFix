...
<html>
	...
	<body>
		<s:form  id="formId" action="tmBalanceItemInsertAction.action">
			<table>
				<tr>
					<td>结算项目</td>
					<td>
				...
				<tr>
					<td>明细名称</td>
					<td>
						<s:textfield id="itemName" name="tmBalanceItem.itemName" onblur="sendChn('itemName','itemCode');"/>
						<font color="red">*</font>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2" align="center">
						<input type="button" value="增加" id="btn" onclick="validateSubmit();"/>
						&nbsp;&nbsp;
