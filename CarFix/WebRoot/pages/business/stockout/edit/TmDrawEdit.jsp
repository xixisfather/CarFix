...
<html>
	...
	<body onload="handlerE3Table();" >
		<s:form action="updateDrawAction.action" >
			...
			<table>
				<tr>
					...
					<td>领用人：</td>
					<td><s:textfield id="userRealName" onfocus="openWin()"  name="#request.tmUser.userRealName" /><font color="red">*</font></td>
					<td>操作员：</td>
		 ...
		 <e3t:table id="tmStockOutDetailTable" uri="initEditSellPageAction.action" var="detVo"
			scope="request" items="detVos" mode="ajax" caption="领用出库明细" statusVar="vv"
		...
		<div id="partinfocollectionDiv" ></div>
		 &nbsp;合计数量： <span id="totalnumspan" > </span> &nbsp;&nbsp;领用合计： <SPAN id="totalpricespan" ></SPAN>&nbsp;&nbsp;
