...
<html>
	...
	<body onload="handlerE3Table();" >
		<s:form action="updateAllotOutAction.action" >
		 ...
		 <e3t:table id="tmStockOutDetailTable" uri="initEditSellPageAction.action" var="detVo"
			scope="request" items="detVos" mode="ajax" caption="调拨出库明细" statusVar="vv"
		...
		<div id="partinfocollectionDiv" ></div>
		 &nbsp;合计数量： <span id="totalnumspan" > </span> &nbsp;&nbsp;调拨合计： <SPAN id="totalpricespan" ></SPAN>&nbsp;&nbsp;
