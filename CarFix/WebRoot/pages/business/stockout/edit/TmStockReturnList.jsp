...
<html>
	...
	<script type="text/javascript">
		...
		function tmStockOutTableConfigHandler(pConfig) {
			...
			{	
				...
				handler : function() {
					...
					addObject('findStockAction.action',800,450);
				}
			}, '', '-', '', {
				text : '刷新',
				iconCls : 'refreshIcon',
		...
		function tmStockOutTableE3ConfigHandler(pConfig) {
			...
			pConfig.form = "findStockReturnAction";
			pConfig.showLoadingMsg = true;
		}
		
	</script>
	<body>
		<s:form action="findStockReturnAction.action" >
			<table>
				<tr>
					<td>出库单号：</td>
		...
		<e3t:table id="tmStockOutTable" uri="findStockReturnAction.action" var="stockOut"
			scope="request" items="stockOutList" mode="ajax" caption="采购退货列表"
			toolbarPosition="bottom" skin="E3002" pageSize="10" width="700"
			height="320" >
			<e3t:column property="stockOutCode" title="退货单号" />
			...
			<e3t:column property="no" title="操作"
				sortable="false">
				<a href="javascript:editObject('${stockOut.stockOutId}','initEditStockReturnPageAction.action',800,450)">
					<font color="blue">
						修改
					</font>
				</a>
				...
				&nbsp;&nbsp;
				<a href="javascript:editObject('${stockOut.stockOutId}','printCGTHAction.action',600,300);">
					<font color="blue">
						打印
					</font>
				</a>
