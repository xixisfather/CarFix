...
<html>
		...
		function tmStockOutTableConfigHandler(pConfig) {
			...
			{	
				...
				handler : function() {
					...
					addObject('initDrawPageAction.action',800,450);
				}
			}, '', '-', '', {
				text : '刷新',
				iconCls : 'refreshIcon',
	...
	<body>
		<s:form action="findDrawAction.action" >
			<table>
				<tr>
					<td>出库单号：</td>
		...
		<e3t:table id="tmStockOutTable" uri="findDrawAction.action" var="stockOut"
			scope="request" items="stockOutList" mode="ajax" caption="领用单列表"
			...
			<e3t:column property="no" title="操作"
				sortable="false">
				<a href="javascript:editObject('${stockOut.stockOutId}','initEditDrawPageAction.action',800,450);">
					<font color="blue">
						修改
					</font>
				</a>
			 ...
			 &nbsp;&nbsp;
				<a href="javascript:editObject('${stockOut.stockOutId}','printLYCKAction.action',600,300);">
					<font color="blue">
						打印
					</font>
				</a>
