...
//打开配件列表窗口
function showWin(){
	var url = "chooseTbPartInfoLianceAction.action?typeName="+encodeURIComponent(loanRegTypeName);	
...
function createGrid(){
    ...
    grid = new Ext.grid.GridPanel({
        ...
        columns: [
            ...
            {header: "借出价", width: 100, sortable: true, dataIndex:'price'},
...
function addPartCollection(confirm){
	...
	if( document.getElementById("loanDate").value == ""){
		Ext.MessageBox.alert('温馨提示：', '借出日期不能为空.', null);
		return;
	}
