...
<html>
	...
	<body>
		<s:form action="tbCarInfoLostAction.action">
			<table>
				<tr>
					<td>
						牌照号
		...
		<e3t:table id="tbCarInfoTable" uri="tbCarInfoLostAction.action" var="tbCarInfo"
			scope="request" items="tbCarInfoLost" mode="ajax"
			toolbarPosition="bottom" skin="E3002" pageSize="10" width="1000"
			height="200" caption="流失客户车辆信息">
			<e3t:column property="lastFixDay" title="上次修理时间" width="200">
		...
		<s:form action="tbReturnVisitFindAction.action">
			<table>
				<s:hidden id="returnType" name="tbReturnVisit.returnType" value="1"></s:hidden>
				<tr>
					<td>
						牌照号
					</td>
