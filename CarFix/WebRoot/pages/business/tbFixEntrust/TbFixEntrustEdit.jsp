...
<script language="javascript">
	...
	function init(){
		...
		td_1_0.innerHTML="<input type='hidden' id='tbWorkingInfoId"+index+"' name='tbWorkingInfoId"+index+"' value='<%=tbFixEntrustContent.getTbWorkingInfo().getId()%>'/>"+"<font color=\"blue\" onclick=\"deleteTd(this);\" style=\"cursor: pointer;\">删除</font>"+"&nbsp;&nbsp;"+"<font color=\"blue\" onclick=\"workingInfoShare('"+index+"')\" style=\"cursor: pointer;\">派工</font>";
		...
		td_1_3.innerHTML = "<input type='text' id='stationName"+index+"' name='stationName"+index+"' value='<%=tbFixEntrustContent.getStationName()%>' size='10' maxlength='20' onfocus='this.select();'/>"; 
		            
		var td_1_4= document.createElement("td");
		            
		td_1_4.innerHTML = "<input type='text' id='fixHour"+index+"' name='fixHour"+index+"' value='<%=tbFixEntrustContent.getFixHour()%>' onblur='parentCountHour();' size='10'/>";
		...
		td_1_6.innerHTML = "<input type='text' id='sendHour"+index+"' name='sendHour"+index+"' value='<%=tbFixEntrustContent.getSendHour()%>' onblur='parentCountHour();' size='10'/>";
