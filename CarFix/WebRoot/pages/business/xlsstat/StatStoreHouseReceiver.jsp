...
<html>
	...
	<script type="text/javascript">
		...
		function stStoreHouseReceiverTableE3ConfigHandler(pConfig) {
			...
			pConfig.form = "findStoreHouseReceiverAction";
	...
	<body>
		...
		<s:form action="findStoreHouseReceiverAction.action">
			<table>
				<tr>	
		...
		<e3t:table id="stStoreHouseReceiverTable" uri="findStoreHouseReceiverAction.action" var="sHouseReceiver"
