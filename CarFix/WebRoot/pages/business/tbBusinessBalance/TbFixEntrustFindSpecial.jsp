...
<html>
	...
	<body>
		<s:form action="tbFixEntrustChooseSpecialAction.action">
			<table>
		...
		<e3t:table id="tbFixEntrustTable" uri="tbFixEntrustChooseSpecialAction.action" var="tbFixEntrust"
			...
			<e3t:column property="checkTbFixEntrustId" style="width:25px"  title="" sortable="false" >
      			<input type="radio" id="entrust${status.globalCount}" value="${tbFixEntrust.id}" name="checkTbFixEntrustId" onclick="setV('${tbFixEntrust.id}')"/>
    		</e3t:column>
...
%>
	...
	function tbFixEntrustTableE3ConfigHandler(pConfig) {
		...
		pConfig.form = "tbFixEntrustChooseSpecialAction";
