...
<html>
	...
	<body>
		<s:form action="tbBusinessBalanceOrderFindAction.action">
			<table>
		...
		<e3t:table id="tbBusinessBalanceTable" uri="tbBusinessBalanceOrderFindAction.action" var="tbBusinessBalance"
...
function tbBusinessBalanceTableE3ConfigHandler(pConfig) {
	...
	pConfig.form = "tbBusinessBalanceOrderFindAction";
