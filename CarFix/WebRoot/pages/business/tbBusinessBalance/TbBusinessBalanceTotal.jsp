				...
				<tr>
					...
					<td>	
						<s:if test="null==tbMembershipCard">
							其中会员卡支付金额<s:textfield id="cardZFJE" value="0" disabled="true"></s:textfield>
						</s:if>
						<s:else>
							其中会员卡支付金额<s:textfield id="cardZFJE" value="0"></s:textfield>
						</s:else>
...
<script>
	...
	//	var p_cardId = parent.document.getElementById('cardId');
		
	//	p_cardId.value = cardId.value;
