			...
			<table>
				...
				<tr>
					<td colspan="6" align="center">
						<input type="button" value="打印" onclick="javascript:editObject('${tbBusinessBalance.id}','tbBusinessBalanceXsdPrintAction.action',600,300);"/>
						&nbsp;&nbsp;
...
<script language="javascript">
	...
	Ext.onReady(function(){
		...
		[
			{
				id:'tbBusinessBalanceTab' , title:'结算清单',disabled:false,url:'tbBusinessBalanceTotalXsdGroupViewAction.action?tbBusinessBalanceId='+tbBusinessBalanceId.value
			},
			{
				id:'tbFixEntrustPartSoleContent' , title:'销售材料',disabled:false,url:'tmStockOutDetailGroupViewAction.action?tmStockOutId='+tmStockOutId.value+'&tbBusinessBalanceId='+tbBusinessBalanceId.value
			},
			{
				id:'tmBalanceItemTab' , title:'结算项目明细',disabled:false,url:'tmBalanceItemGroupCalcXsdViewAction.action?tbBusinessBalanceId='+tbBusinessBalanceId.value+'&tmBalanceId='+tmBalanceId.value
			}
