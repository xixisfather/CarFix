...
<html>
	...
	<body>
		<s:form action="tbBusinessSpecialBalanceInsertAction.action">
			<table>
				<tr>
					<td>
				...
				<tr>
					<td colspan="6">
						...
						<table id="tbWorkingInfoTable" border="0">
							...
							<s:if test="#request.tbFixEntrustContentList!=null">
								
								<s:iterator id="tbFixEntrustContent" value="#request.tbFixEntrustContentList" status="status">
									...
									<tr>
										...
										<td>${tbFixEntrustContent.stationCode}</td>
										<td><input type="text" id="stationName${status.index}" name="stationName${status.index}" value="${tbFixEntrustContent.stationName}"/></td>
					...
					<div id="partContent" class="x-hide-display">
						<table id="partInfoTable">
							...
							<s:if test="#request.partAll!=null">
								<s:iterator id="sellStock" value="#request.partAll" status="status">
									<tr style="display: none">
										
										
									</tr>
									<tr>
										<td><input type="hidden" id="tbPartInfoId${status.index}" name="tbPartInfoId${status.index}" value="${sellStock.partId}"/><a onclick="deleteTd(this);"><font color="blue">删除</font></a></td>
...
<%
	List workingInfoList = (List)request.getAttribute("tbFixEntrustContentList");
	...
	List partAll = (List)request.getAttribute("partAll");
