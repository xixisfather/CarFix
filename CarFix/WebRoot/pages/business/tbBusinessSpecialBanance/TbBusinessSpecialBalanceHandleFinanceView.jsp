...
-->
	...
	<body>
		<s:form action="tbBusinessSpecialBalanceHandleFinanceViewAction.action" onsubmit="return validate()">
		<div id="apDiv1">
			<table width="1000" border="0">
				<tr>
					...
					<td width="611">
						统计月份
						从
						<s:textfield id="staticsDateStart" name="tbBusinessSpecialBalanceHandleFinance.staticsDateFrom" readonly="true" size="15"/> 
						<e3c:calendar for="staticsDateStart" dataFmt="yyyy-MM"/>
						至
						...
						&nbsp;&nbsp;
						<input type="submit" value="确定" class="buttonNoPrint"/>
						&nbsp;&nbsp;
						<input type="button" value="打印" class="buttonNoPrint" onclick="window.print();"/>
					</td>
					<td width="243">
						金额单位:人民币元
					</td>
		...
		<div id="apDiv2" style="border: 1px; border-style: solid;">
			...
			<div id="apDiv6">
				<table width="236" height="94" border="0">
					...
					<s:if test="#request.staticCarModelTypeList==null">
					<s:iterator id="tmCarModelType" value="#request.tmCarModelTypeList" status="status">
							...
							<tr>
								...
								<td width="124">
									<input type="text" id="tmCarModelType${status.index}" name="tmCarModelType${status.index}" size="3"/>
								</td>
							</tr>
			...
			<div id="apDiv5" style="border: 1px; border-style: solid;">
				<table width="236" border="0">
					...
					<s:if test="#request.tmFixTypeList!=null">
						<s:if test="#request.staticFixTypeList==null">
						<s:iterator id="tmFixType" value="#request.tmFixTypeList" status="status">
							...
							<tr>
								...
								<td width="124">
									<input type="text" id="tmFixType${status.index}" name="tmFixType${status.index}" size="3"/>
								</td>
							</tr>
...
<script language="javascript">
	...
	function validate(){
		...
		var staticsDateStart = document.getElementById("staticsDateStart");
		
		var staticsDateEnd = document.getElementById("staticsDateEnd");
		
		if(null==staticsDateStart.value||''==staticsDateStart.value||null==staticsDateEnd.value||''==staticsDateEnd.value){
