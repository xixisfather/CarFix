...
<html>
	...
	<body>
		<s:form action="tbBusinessSpecialBalanceXsdUpdateAction.action" >
			...
			<table>
								...
								<s:iterator id="itemValue" value="#session.calcMapReturn.get(#itemCode)">
									...
									<s:iterator id="tmBalanceItem" value="#request.tmBalanceItemList">
										<s:if test="#tmBalanceItem.itemCode==#itemCode">
											...
											<td>
												<input type="text" id="${itemCode}" name="${itemCode}" value="${itemValue}" onblur="calcAjaxXsd('${itemCode}')" disabled="true"/>
											</td>
										</s:if>
									</s:iterator>
				...
				<tr>
					<td colspan="6" align="center">
						<input type="button" value="打印" onclick="javascript:editObject('${tbBusinessSpecialBalance.id}','tbBusinessSpecialBalanceXsdPrintAction.action',600,300);"/>
...
<script language="javascript">
	<%
	List tbSpecialPartContentList = (List)request.getAttribute("tbSpecialPartContentList");
	
	int fCount = 0 ; 
	
	if(null!=tbSpecialPartContentList){
		fCount = tbSpecialPartContentList.size();
	}
%>
