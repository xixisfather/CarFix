...
<html>
	...
	<script type="text/javascript" src="<%= request.getContextPath() %>/pages/business/stockin/linance.js" charset="UTF-8"></script>
	...
	<script type="text/javascript">
		...
		var lianceRegTypeName = "${lianceRegTypeName}";
	...
	<body>
		<s:form action="insertLianceRegisterAction.action" >
			...
			<table>
				...
				<tr>
					...
					<td>经办人:</td>
					<td><s:textfield name="peopleName" onfocus="openPeoWin();" /><font color="red">*</font></td>
				</tr>
			</table>
		</s:form>
