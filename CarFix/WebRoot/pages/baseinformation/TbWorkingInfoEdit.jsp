...
<html>
	...
	<body>
		<s:form id="form" action="tbWorkingInfoUpdateAction.action">
			<table>
				<tr>
					<td><s:hidden name="tbWorkingInfo.id"/></td>
				</tr>
				<tr>
					<td>工位代号</td>
					<td>
				...
				<tr>
					...
					<td>修理工时</td>
					<td>
						<s:textfield id="fixHour" name="tbWorkingInfo.fixHour"/><font color="red">*</font>
					</td>
				...
				<tr>
					<td>派工工时</td>
					<td>
						<s:textfield id="sendHour" name="tbWorkingInfo.sendHour"/><font color="red">*</font>
					</td>
				</tr>
				<tr>
					<td>选择车型工位</td>
					<td>
						<s:select id="tmCarStationTypeId" name="tbWorkingInfo.tmCarStationTypes" list="#request.tmCarStationTypeMap" listKey="key" listValue="value" disabled="true"></s:select>
					</td>
