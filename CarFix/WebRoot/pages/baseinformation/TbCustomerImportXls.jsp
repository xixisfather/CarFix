...
<html>
	...
	<body>
		<s:form id="importXlsForm" action="tbCustomerImportXlsAction.action" enctype="multipart/form-data">
			<table>
				<tr>
					<td>选择数据文件</td>
					<td>
						<input type="hidden" name="e3Table" value="<%=request.getParameter("e3Table")%>"/>
