...
<html>
	...
	<body onload="document.getElementById('licenseCode').focus();">
		<s:form action="tbCarInfoUpdateAction.action" onsubmit="return carInfoFormValidate()">
			<table>
				<tr>
					<td>
						<s:hidden name="tbCarInfo.tbCustomer.id"/>
						<s:hidden id="carId" name="tbCarInfo.id"/>
					</td>
				</tr>
				<tr>
					<td>客户号</td>
				...
				<tr>
					...
					<td>
						<s:textfield id="purchaseDate" name="tbCarInfo.purchaseDate">
							<s:param name="value"><s:date name="tbCarInfo.purchaseDate" format="yyyy-MM-dd"/></s:param>
						</s:textfield>
				...
				<tr>
					...
					<td>
						<s:textfield id="productDate" name="tbCarInfo.productDate">
							...
							<s:param name="value"><s:date name="tbCarInfo.productDate" format="yyyy-MM-dd"/></s:param>
					...
					<td>
						<s:textfield id="insureDeadlineDate" name="tbCarInfo.insureDeadlineDate">
							...
							<s:param name="value"><s:date name="tbCarInfo.insureDeadlineDate" format="yyyy-MM-dd"/></s:param>
						</s:textfield>
				...
				<tr>
					...
					<td>
						<s:textfield id="yearCheckDeadline" name="tbCarInfo.yearCheckDeadline">
							<s:param name="value"><s:date name="tbCarInfo.yearCheckDeadline" format="yyyy-MM-dd"/></s:param>
						</s:textfield>
				...
				<tr>	
					...
					<td>
						<s:textfield id="licenseDate" name="tbCarInfo.licenseDate">
							<s:param name="value"><s:date name="tbCarInfo.licenseDate" format="yyyy-MM-dd"/></s:param>
						</s:textfield>
